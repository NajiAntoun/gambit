...
- [ ] M1.1 Initialize Git repository
- [ ] M1.2 Create CLAUDE.md, BRIEF.md and PRD.md
- [ ] M1.3 Scaffold frontend and backend projects
- [ ] M1.4 Set up deployment configuration for both
- [ ] M1.5 Set up environment variables and gitignore
- [ ] M1.6 First commit: "Project scaffold"

### Milestone 2 — Data & Board
- [ ] M2.1 Create opening data file with PGN for all openings
- [ ] M2.2 Build chess board component
- [ ] M2.3 Board flips correctly based on chosen color
- [ ] M2.4 Move highlighting works correctly
- [ ] M2.5 Commit: "Chess board + opening data"

### Milestone 3 — Opening Selection UI
- [ ] M3.1 Home screen with color picker
- [ ] M3.2 Opening list grouped by category
- [ ] M3.3 Difficulty badges and progress status indicators
- [ ] M3.4 Search and filter functionality
- [ ] M3.5 Mode selection screen
- [ ] M3.6 Commit: "Opening selection UI"

### Milestone 4 — Learn Mode
- [ ] M4.1 Step through moves with Previous / Next navigation
- [ ] M4.2 Move list panel with current move highlighted
- [ ] M4.3 Strategic explanation per move
- [ ] M4.4 Smooth animations
- [ ] M4.5 Commit: "Learn mode complete"

### Milestone 5 — Quiz Mode
- [ ] M5.1 Auto-play opponent moves
- [ ] M5.2 User move validation
- [ ] M5.3 Correct and wrong move visual feedback
- [ ] M5.4 Score tracking throughout session
- [ ] M5.5 Session summary screen
- [ ] M5.6 Progress update logic (Learning → Mastered)
- [ ] M5.7 Commit: "Quiz mode complete"

### Milestone 6 — AI Integration
- [ ] M6.1 Backend API endpoint for move explanations
- [ ] M6.2 Claude API integration
- [ ] M6.3 "Ask Gambit" button in Learn mode
- [ ] M6.4 Wrong move AI explanation in Quiz mode
- [ ] M6.5 Hardcoded fallbacks if API unavailable
- [ ] M6.6 Commit: "AI integration complete"

### Milestone 7 — Progress Dashboard
- [ ] M7.1 Dashboard screen
- [ ] M7.2 Progress persistence between sessions
- [ ] M7.3 Visual progress indicators
- [ ] M7.4 Commit: "Progress dashboard"

### Milestone 8 — Polish & Deploy
- [ ] M8.1 Mobile responsiveness pass
- [ ] M8.2 Animation and UX polish
- [ ] M8.3 Deploy frontend
- [ ] M8.4 Deploy backend
- [ ] M8.5 Connect frontend to backend
